...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    const users = [
      ...
      new User('samjones', 'Sam', 'Jones', ['Fitness', 'Trekking', 'Football'], 989748484, 'https://s3.amazonaws.com/uifaces/faces/twitter/josephstein/128.jpg'),
      new User('dougcharles', 'Doug', 'Charles', ['Cooking', 'Basketball'], 347979595, 'https://s3.amazonaws.com/uifaces/faces/twitter/bigmancho/128.jpg'),
